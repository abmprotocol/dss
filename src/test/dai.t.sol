...
contract TokenUser {
    ...
    constructor(dotBtc token_) public {
        token = token_;
    }
...
contract dotBtcTest is DSTest {
    ...
    function createToken() internal returns (dotBtc) {
        return new dotBtc(99);
    }
    ...
    function testdotBtcAddress() public {
